...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Create 25 user data that a female tutor
        for ($i = 0; $i < 25; ++$i) {
            User::factory()->create([
                'user_type' => 'Tutor',
                'name' => $arrayTutor[$i],
        ...
        //Create 25 user data that a male tutor
        ...
        //Create user data that orphanage
        for ($i = 0; $i < count($arrayPhoneNumber); ++$i) {
            $randGender = $faker2->randomElement(['Male', 'Female']);
            User::factory()->create([
